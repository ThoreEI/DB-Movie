...
session_start();
if (isset($_POST["add_movie"])) $data_base->insert_record($_POST["title"], $_POST["director"], $_POST["year"], $_POST["playtime"], $_POST["fsk"]);
if (isset($_POST["delete_movie"])) $data_base->delete_movie($_POST["delete_movie"]);
if (isset($_POST["reset_session"])) session_unset();
